...
- 💻 Strong foundation in **Core Computer Science** (OOP, Data Structures & Algorithms, Databases, Operating Systems, Computer Networks)
- 🐧 Passionate about **Linux, System Programming, Operating Systems, and Low-Level Software**
- ⚙️ Currently focusing on **C/C++, Linux Internals, Bash, and Systems Software Engineering**
- 🤝 Active member of **ICPC Mansoura Community** with competitive programming experience
- 🚀 Always eager to learn, build practical projects, and contribute to open-source software
